...
- Verb 1: {{gen 'verb_1' max_tokens=2}}
- Verb 2: {{gen 'verb_2' max_tokens=2}}
- Verb 3: {{gen 'verb_3' max_tokens=2}}
- Noun 2: {{gen 'noun_2' max_tokens=2}}
- Food 2: {{gen 'food_2' max_tokens=2}}
{{/block}}
...
friends were willing to share their {{clean_string food_2}} with her.
{{/block}}
"""
    print(base_template)
